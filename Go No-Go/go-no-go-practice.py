...
nConditions = 2 # 2
nBlocks = 1
nTrials = 12 # per block - must be divisible by 6
#nBlocks = 4     #
...
endScreen = visual.TextStim(
            ...
            wrapWidth=textWrap,
            height=textHeight,
            text="End of practice - thank you!\n\nPlease tell the researcher whether you would like to have another go at the practice or whether you are ready to start the real task.",
            )
