...
practiceText = visual.TextStim(
            win,
            height=0.07,
            text="We will now have a practice run.\n\nTell the researcher when you are ready to begin."
            )
...
endScreen = visual.TextStim(
            ...
            text="End of practice - thank you!\n\nPlease tell the researcher that you have finished.",
            )


correctText = visual.TextStim(
            win,
            height=feedbackHeight,
            text="Correct go",
            color='#005100'            
...
incorrectText = visual.TextStim(
            win,
            height=feedbackHeight,
            text="Incorrect arrow"
            )

missedText = visual.TextStim(
            win,
            height=feedbackHeight,
            text="Missed arrow"
            )

failedText = visual.TextStim(
            win,
            height=feedbackHeight,
            text="Failed stop",
            color='#990000'
...
successfulText = visual.TextStim(
            win,
            height=feedbackHeight,
            text="Successful stop",
            color='#005100'
            )
